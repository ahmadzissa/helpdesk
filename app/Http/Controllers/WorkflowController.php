...
class WorkflowController extends Controller
{
    public function index(): JsonResponse
    {
        return response()->json([
            ...
            'runs' => DB::table('automation_runs')->join('automations', 'automations.id', '=', 'automation_runs.automation_id')->select('automation_runs.*', 'automations.name')->orderByDesc('automation_runs.id')->limit(50)->get(),
            'follow_ups' => DB::table('follow_ups')->orderByDesc('id')->limit(50)->get(),
        ]);
    }
